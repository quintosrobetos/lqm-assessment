...
function RocketIcon({size=20}) {
  ...
  return (
    <svg width={w} height={size} viewBox="0 0 13 20"
      style={{display:"inline-block",verticalAlign:"middle",flexShrink:0,
        animation:"rocketFloat 2.6s ease-in-out infinite"}}>
      <path d="M6.5 1C6.5 1 3.5 4 3.5 9.5L3.5 14L9.5 14L9.5 9.5C9.5 4 6.5 1 6.5 1Z"
        fill="#FFFFFF" opacity="0.92"/>
      <circle cx="6.5" cy="9" r="1.6" fill="#00C8FF" opacity="0.88"/>
      <path d="M3.5 12L1.5 16.5L3.5 14Z" fill="#7DD3FC" opacity="0.82"/>
      <path d="M9.5 12L11.5 16.5L9.5 14Z" fill="#7DD3FC" opacity="0.82"/>
      <path d="M4.5 14L4.5 17C4.5 17 6.5 18 8.5 17L8.5 14Z" fill="#00C8FF" opacity="0.65"/>
      <path d="M5.5 17C5.5 17 6.5 19.5 7.5 17Z" fill="#FFFFFF" opacity="0.75"/>
    </svg>
  );
}
    ...
    <div style={{minHeight:"100vh", background:`radial-gradient(ellipse 80% 40% at 50% 0%,rgba(52,211,153,0.06) 0%,transparent 60%),${BG}`, fontFamily:"'Space Grotesk',sans-serif", color:WHITE, display:"flex", flexDirection:"column", alignItems:"center", padding:"0 16px 60px", position:"relative", overflow:"hidden"}}>
      ...
      <div style={{width:"100%",borderBottom:`1px solid ${BORDER}`,padding:"12px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",background:"rgba(7,15,30,0.9)",backdropFilter:"blur(14px)",position:"sticky",top:0,zIndex:100}}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          <span style={{fontSize:13,fontWeight:700,color:checklist[todayLawIdx]?GREEN:MUTED}}>
            {checklist[todayLawIdx]?"1":"0"}{" of 1 "}<FlameIcon size={13}/>
          </span>
      ...
      <div style={{width:"100%",maxWidth:620,paddingTop:28,zIndex:1}}>
        ...
        <div style={{marginBottom:16,animation:"fadeUp .5s ease both"}}>
          ...
          <div onClick={()=>toggleCheck(todayLawIdx)} style={{
            ...
            <div style={{flex:1}}>
              ...
              <p style={{fontSize:15,color:MUTED,lineHeight:1.65}}>{checklist[todayLawIdx] ? "Streak logged — come back tomorrow" : todayLaw.todaySummary}</p>
            </div>
            {!checklist[todayLawIdx] && (
              <div style={{
        ...
        <div
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              ...
              <div>
                <p style={{fontSize:12,fontWeight:700,color:"rgba(52,211,153,0.65)",letterSpacing:".14em",textTransform:"uppercase",marginBottom:2}}>Today's Natural Intelligence</p>
        ...
        <div style={{marginTop:8,padding:"14px 18px",background:"rgba(255,255,255,0.02)",border:`1px solid ${BORDER2}`,borderRadius:12}}>
          <p style={{fontSize:15,color:MUTED,lineHeight:1.7}}>The 5 Quantum Laws are educational principles for general wellbeing — not medical advice. Please consult a doctor before making changes to exercise or health habits. Natural product descriptions are educational and do not constitute medical claims.</p>
        </div>
      </div>
    </div>
  );
